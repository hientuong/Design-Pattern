...
struct iOSDeveloperJobSeeker: JobContactProtocol{
    ...
    func sendRequestResumeEmail() -> String {
        return "Dear \(contact.name), this is the best time to be an a iOS developer! Send me you're resume today! I have job opportunities that pay \(contact.desiredSal)."
    }
}
...
struct AndroidDeveloperJobSeeker: JobContactProtocol{
    ...
    func sendRequestResumeEmail() -> String {
        return "Dear \(contact.name), this is the best time to be an a Android developer! Send me you're resume today! I have job opportunities that pay \(contact.desiredSal)."
    }
}
